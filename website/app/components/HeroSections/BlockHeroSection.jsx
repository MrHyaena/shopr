export function BlockHeroSection({
  ...
  return (
    <>
      <div className="lg:min-h-[800px] lg:grid flex flex-col-reverse grid-cols-5 min-h-screen items-stretch xl:justify-center justify-start overflow-x-hidden lg:p-0 p-5">
