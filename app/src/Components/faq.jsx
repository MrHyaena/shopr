...
export function Faq() {
  const [problemToggle, setProblemToggle] = useState(1);
    ...
    return (
      <>
        <div
          ...
          className="p-5 bg-white rounded-lg border border-slate-200  xl:w-[45%]"
        >
    ...
    <>
      <div className="bg-slate-50 p-10 flex flex-col xl:gap-10 gap-10 xl:pt-10 pt-30 text-textDark">
        ...
        <div className="flex flex-col items-center gap-5">
          <h1 className="text-xl font-bold text-heading">Předplatné</h1>
          <Question
          ...
          <h1 className="text-xl font-bold text-heading">Uživatelský účet</h1>
          <Question text={"Jak změnit své osobní údaje?"} index={1} />
          <Question text={"Jak změnit své osobní údaje?"} index={1} />
          <Question text={"Jak změnit své osobní údaje?"} index={1} />
          <h1 className="text-xl font-bold text-heading">Cena</h1>
          <Question text={"Jak změnit své osobní údaje?"} index={1} />
          <Question text={"Jak změnit své osobní údaje?"} index={1} />
        </div>
      </div>
