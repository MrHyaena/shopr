    ...
    <>
      <div className="flex flex-col items-center justify-center xl:py-30 bg-white">
        <div className="max-w-wrapper w-full lg:grid flex-col grid-cols-2 items-center justify-center gap-0 p-3">
          ...
          <div
            className=" gap-3 grid grid-cols-2 rounded-3xl rounded-tl-4xl xl:mt-0 mt-10"
            data-aos="fade-right"
          >
            <div className="mt-10 flex flex-col gap-10 text-center">
              <div className="flex flex-col gap-3 items-center">
                ...
                <Image
                  src={imageOne}
                  alt="firstImage"
                  className="object-cover object-center rounded-md xl:w-60 xl:h-60 h-40 w-40 justify-self-center shadow-lg"
                />
              </div>
              <div className="flex flex-col gap-3 items-center">
